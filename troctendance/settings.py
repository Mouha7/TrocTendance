"""
Django settings for TrocTendance project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'troctendance.onrender.com']
...
ROOT_URLCONF = 'troctendance.urls'
...
WSGI_APPLICATION = 'troctendance.wsgi.application'
